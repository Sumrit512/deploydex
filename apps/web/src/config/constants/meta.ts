...
export const DEFAULT_META: PageMeta = {
  title: 'UniExchange',
  description:
    'The most popular AMM on BSC by user count! Earn MNB through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by UniExchange), NFTs, and more, on a platform you can trust.',
  image: `https://mnb3d.com/MNB_logo.png`,
